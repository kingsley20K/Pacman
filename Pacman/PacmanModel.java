...
//            }
        ...
        for (int i = 0; i < N_GHOSTS; i++) {
            if (pacman_x > (ghost_x[i]-12) && pacman_x < (ghost_x[i]+12) && pacman_y > (ghost_y[i]-12) && pacman_y < (ghost_y[i]+12)&& isInGame()) {
                // Collision détectée, gestion de la mort de Pac-Man
                //death();
                setDying(true);
                //return; // Sortir de la méthode après la gestion de la collision
            }
        }
    }
    /**
     ...
     */
    public int getN_GHOSTS(){return N_GHOSTS;}
    ...
    /**
     * retourner la vitesse du joueur
